...
public:
    ...
    public:
        ...
        template<DestructionConcurrency, typename DestroyFunc>
    ...
    private:
        ...
        template<DestructionConcurrency, bool, EmptyMode, SweepMode, SweepDestructionMode, ScribbleMode, NewlyAllocatedMode, MarksMode, typename DestroyFunc>
